...
export const MAX_DELAY_FOR_ZERO = 3 * NANOSECONDS_IN_A_SECOND;
export const SPEED_SAMPLE_PERIOD = 5 * NANOSECONDS_IN_A_SECOND;
export const CADENCE_SAMPLE_PERIOD = 12 * NANOSECONDS_IN_A_SECOND;
